...
####
The question we would liek to answer is: what the unemployment rate will be in the next month, as well as the rate aat the end of this year (December 2022).
One of the machine learning models we intend to implement is the K-Nearest Neighbor (KNN) algorithm. KNN can be used for either linear  regression or classification.
